...
<body>
    ...
    <p>Here comes an iFrame from host1.com</p>
    <iframe src="http://host1.com/web-engineering-2/demos/04/cookie-attributes/get-cookie.php" style="border: 2px solid black; width: 100%;"></iframe>
